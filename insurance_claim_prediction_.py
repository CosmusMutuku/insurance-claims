# -*- coding: utf-8 -*-
"""Insurance_claim_prediction_.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1CG5HI-aaXycQOGQz_u19zkcm2q8sr3GH
...
#variables
X=train.drop(['is_claim', 'policy_id'], axis=1)
X
...
X_train, X_test, y_train, y_test = train_test_split(X_transformed, y, test_size=0.4, random_state=50)
